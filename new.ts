...
<body>
  <div class=\"container\">
    ...
    <div class=\"stats-grid\">
      <div class=\"stat-card\"><h3><div class=\"api-icon gemini-icon\">G</div>Gemini/GnoThink 调用统计</h3>
        <div class=\"stat-row\"><span class=\"stat-label\">24小时</span><span class=\"stat-value\">${combinedGeminiStats.today}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">7天</span><span class=\"stat-value\">${combinedGeminiStats.week}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">30天</span><span class=\"stat-value\">${combinedGeminiStats.month}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">总计</span><span class=\"stat-value\">${combinedGeminiStats.total}</span></div>
      </div>
      <div class=\"stat-card\"><h3><div class=\"api-icon groq-icon\">⚡</div>Groq API 调用统计</h3>
        <div class=\"stat-row\"><span class=\"stat-label\">24小时</span><span class=\"stat-value\">${groqStats.today}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">7天</span><span class=\"stat-value\">${groqStats.week}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">30天</span><span class=\"stat-value\">${groqStats.month}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">总计</span><span class=\"stat-value\">${groqStats.total}</span></div>
      </div>
      <div class=\"stat-card\"><h3><div class=\"api-icon openrouter-icon\">🔗</div>OpenRouter API 调用统计</h3>
        <div class=\"stat-row\"><span class=\"stat-label\">24小时</span><span class=\"stat-value\">${openrouterStats.today}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">7天</span><span class=\"stat-value\">${openrouterStats.week}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">30天</span><span class=\"stat-value\">${openrouterStats.month}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">总计</span><span class=\"stat-value\">${openrouterStats.total}</span></div>
      </div>
      <div class=\"stat-card\"><h3><div class=\"api-icon chutes-icon\">🏹</div>Chutes AI 调用统计</h3>
        <div class=\"stat-row\"><span class=\"stat-label\">24小时</span><span class=\"stat-value\">${chutesStats.today}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">7天</span><span class=\"stat-value\">${chutesStats.week}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">30天</span><span class=\"stat-value\">${chutesStats.month}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">总计</span><span class=\"stat-value\">${chutesStats.total}</span></div>
      </div>
      <div class=\"stat-card\"><h3><div class=\"api-icon nebius-icon\">N</div>Nebius API 调用统计</h3>
        <div class=\"stat-row\"><span class=\"stat-label\">24小时</span><span class=\"stat-value\">${nebiusStats.today}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">7天</span><span class=\"stat-value\">${nebiusStats.week}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">30天</span><span class=\"stat-value\">${nebiusStats.month}</span></div>
        <div class=\"stat-row\"><span class=\"stat-label\">总计</span><span class=\"stat-value\">${nebiusStats.total}</span></div>
      </div>
      <div class=\"stat-card\"><h3><div class=\"api-icon total-icon\">📊</div>总体统计</h3>
